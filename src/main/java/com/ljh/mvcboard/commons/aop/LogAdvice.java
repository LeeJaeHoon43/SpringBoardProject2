package com.ljh.mvcboard.commons.aop;
...
public class LogAdvice {
	...
	@Around("execution(* com.ljh.mvcboard..*Controller.*(..))"
            + " or execution(* com.ljh.mvcboard..service..*Impl.*(..))"
            + " or execution(* com.ljh.mvcboard..persistence..*Impl.*(..))")
