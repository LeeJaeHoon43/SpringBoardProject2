package com.ljh.mvcboard.user.controller;
...
import com.ljh.mvcboard.user.service.UserService;
...
public class UserInfoController {
	...
	public boolean passChk(String userId, String passwordConfirm, RedirectAttributes redirectAttributes) throws Exception{
		// 비밀번호 일치 확인.
		if (!userService.isValidUserPw(userId, passwordConfirm)) {
			return false;
		}
		return true;
	}
	...
	public String userWithdraw(HttpSession session, UserVO vo) throws Exception {
